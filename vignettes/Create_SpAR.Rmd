...
``` r
SpeARP(occurrences = speciation_occurrences, npsi = 1)
```
...
## (Intercept) -1.863e-11  2.193e-02   0.000        1
## x            1.130e-12  1.206e-03   0.000        1
## U1.x         5.712e-03  2.116e-03   2.699       NA
## 
## Residual standard error: 0.01053 on 33 degrees of freedom
## Multiple R-Squared: 0.3983,  Adjusted R-squared: 0.3436 
## 
## Boot restarting based on 6 samples. Last fit:
## Convergence attained in 3 iterations (rel. change 2.1387e-14)
```
