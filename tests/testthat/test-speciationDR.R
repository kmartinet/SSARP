...
# The speciationDR function only really needs "Genus" and "Species" 
...
test_that("When a tree with binomial tip labels is used but the label type is 
  ...
  speciation_rates <- speciationDR(tree = tree_b, label_type = "epithet", 
                                   occurrences = occ_simple)
